...
THREAD_SEEDS = {
    "consensus": {
        ...
        "paper_patterns": [
            ...
            r"proof.of.authority", r"accountability.*gadget",
            r"proof.of.burn", r"eth2\.0.client", r"ethereum.2\.0.client",
            r"soft.fork", r"hard.fork",
        ],
        "category_hints": [],
        "key_authors": [
    ...
    "scaling": {
        ...
        "paper_patterns": [
            ...
            r"scalab.*blockchain", r"blockchain.*scalab",
            r"scaling.*blockchain", r"blockchain.*scaling",
            r"high.scalab.*block",
        ],
        "category_hints": [],
    ...
    "layer2": {
        ...
        "paper_patterns": [
            ...
            r"payment.hub", r"payment.channel", r"payment.network",
            r"off.blockchain.payment", r"off.chain.payment",
            r"path.based.transac", r"rebalanc.*payment",
            r"decentralized.poker", r"decentralized.lottery",
        ],
        "category_hints": [],
    ...
    "mev": {
        ...
        "paper_tags": ["mev", "mev_pbs", "fee-market", "eip-1559", "timing-games"],
        "paper_patterns": [
            ...
            r"transaction.reorder", r"dynamic.fees.*blockchain",
            r"relay\b.*blockchain",
        ],
        "category_hints": [],
        "key_authors": [
    ...
    "execution": {
        ...
        "paper_tags": ["stateless", "execution_state"],
        "paper_patterns": [
            r"verkle", r"stateless", r"state.expir", r"evm", r"opcode",
            r"solidity", r"account.abstract", r"bytecode",
            r"trie", r"state.growth", r"witness",
            r"ethereum.virtual.machine", r"gas.optimiz",
            r"dapp", r"decentralized.application",
            r"peer.to.peer.network.*ethereum", r"ethereum.*peer.to.peer",
            r"ethereum.*graph.analysis",
            r"entire.*ethereum.*blockchain",
        ],
        "category_hints": [],
    ...
    "cryptography": {
        ...
        "paper_patterns": [
            ...
            r"quantum.resist", r"post.quantum",
        ],
        "category_hints": [],
    ...
    "defi": {
        ...
        "paper_tags": [
            "defi", "defi_markets", "amm", "dex", "arbitrage", "lvr",
        ...
        "paper_patterns": [
            ...
            r"\bnfts?\b", r"non.fungible", r"erc.?20\b", r"erc.?721\b",
            r"token.?market", r"maker.protocol", r"wash.trad",
            r"stock.exchange.*decentral", r"decentral.*stock.exchange",
            r"token.*standard", r"token.*ecosystem",
        ],
        "category_hints": [],
        "key_authors": [],
    },
    "privacy": {
        ...
        "paper_patterns": [
            ...
            r"de.anonymi", r"address.cluster",
        ],
        "category_hints": [],
        "key_authors": ["barryWhiteHat"],
    },
    "security": {
        ...
        "paper_patterns": [
            ...
            r"scam", r"phishing", r"ponzi", r"fraud",
            r"malicious", r"illicit", r"intrusion.detect",
            r"criminal", r"sybil", r"double.spend",
            r"account.classif", r"ring.of.gyges",
        ],
        "category_hints": [],
        "key_authors": [],
    },
    "governance": {
        ...
        "paper_patterns": [
            ...
            r"autonomous.organization", r"coin.offering",
            r"decentrali[sz].*measur", r"measur.*decentrali[sz]",
            r"sok.*decentrali[sz]", r"blockchain.*decentrali[sz]ation$",
            r"crowdsourc",
        ],
        "category_hints": [],
        "key_authors": [],
